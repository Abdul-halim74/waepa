        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">E-Newsletter</li>
              <li class="breadcrumb-item active">E-Newsletter Details</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-lg-12 entries">
            ...
            <article class="entry">
              ...
              <div class="entry-img text-center">
                <img src="{{ asset('uploads/enewsletter_image')}}/{{$blog_details->image}}" alt="" class="img-fluid">
              </div>
                  ...
                  <li class="d-flex align-items-center"><i class="icofont-wall-clock"></i> <a href=""><time datetime="2020-01-01">{{$blog_details->created_at}}</time></a></li>
                   ...
                   <li class="d-flex align-items-center"><i class="fa fa-list-alt" aria-hidden="true"></i> <a href="">Categories : 
                    ...
                    <?php 
                     ...
                     $cat = $blog_details->enewsletter_cat;
              ...
              <div class="card-footer">
                <form action="{{url('user_frontend_enewsletter_comment_submit')}}" method="post">
                  @csrf
