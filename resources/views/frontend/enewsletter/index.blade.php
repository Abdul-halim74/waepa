        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">E-Newsletter</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry">
              ...
              <div class="entry-img">
                <img src="{{ asset('uploads/enewsletter_image')}}/{{$single_blog_info->image}}" alt="" class="img-fluid">
              </div>

              <h2 class="entry-title">
                <a href="{{url('enewsletter_details')}}/{{$single_blog_info->id}}">{{$single_blog_info->heading}}</a>
              </h2>
              ...
              <div class="entry-meta">
                ...
                <li class="d-flex align-items-center"><i class="icofont-comment"></i> <a href="{{url('enewsletter_details')}}/{{$single_blog_info->id}}">

                  @php 
                    echo CommentCountController::getCommentCount2( $single_blog_info->id )
                  @endphp
                   ...
                   <li class="d-flex align-items-center"><i class="fa fa-list-alt" aria-hidden="true"></i> <a href="">Categories : 
                    ...
                    <?php 
                     $cat = $single_blog_info->enewsletter_cat;
                    $cat_arry= explode(',', $cat);
                    foreach($cat_arry as $val)
                    {
                      
                      $data = DB::table('enews_letter_category')->where('id', $val)->first();
                      /*echo "<pre>";
                      print_r($data);*/
              ...
              <div class="entry-content">
                ...
                <div class="read-more offset-md-10" style="">
                  <a href="{{url('enewsletter_details')}}/{{$single_blog_info->id}}">Read More</a>
                </div>
              </div>
              ...
              <div class="col-lg-4">
                  ...
                  <div class="sidebar-item categories">
                    <ul>
                      ...
                      @foreach($all_categories as $single_blog_category)
                      ...
                      @endforeach
                                ...
                                <div class="sidebar-item recent-posts">
                                  ...
                                  <div class="post-item clearfix">
                                    <img src="{{ asset('uploads/enewsletter_image')}}/{{$single_blog->image}}" alt="">
                                    <h4><a href="{{url('enewsletter_details')}}/{{$single_blog->id}}">{{$single_blog->heading}}</a></h4>
