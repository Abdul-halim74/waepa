        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Social Events</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry">
              ...
              <div class="entry-img">
                <img src="{{ asset('uploads/social_events')}}/{{$single_blog_info->image}}" alt="" class="img-fluid">
              </div>

              <h2 class="entry-title">
                <a href="{{url('social_events_details')}}/{{$single_blog_info->id}}">{{$single_blog_info->heading}}</a>
              </h2>
              ...
              <div class="entry-meta">
                ...
                <li class="d-flex align-items-center"><i class="icofont-comment"></i> <a href="{{url('social_events_details')}}/{{$single_blog_info->id}}">

                  @php 
                    echo CommentCountController::getCommentCount5( $single_blog_info->id )
                  @endphp
              ...
              <div class="entry-content">
                ...
                <div class="read-more offset-md-10" style="">
                  <a href="{{url('social_events_details')}}/{{$single_blog_info->id}}">Read More</a>
                </div>
              </div>
                      ...
                      <button type="submit"><i class="icofont-search"></i></button>
                                ...
                                <div class="sidebar-item recent-posts">
                                  ...
                                  <div class="post-item clearfix">
                                    <img src="{{ asset('uploads/social_events')}}/{{$single_blog->image}}" alt="">
                                    <h4><a href="{{url('social_events_details')}}/{{$single_blog->id}}">{{$single_blog->heading}}</a></h4>
