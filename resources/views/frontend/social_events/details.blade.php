        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">Social Events</li>
              <li class="breadcrumb-item active">Social Events Details</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-lg-12 entries">
            ...
            <article class="entry">
              ...
              <div class="entry-img text-center">
                <img src="{{ asset('uploads/social_events')}}/{{$blog_details->image}}" alt="" class="img-fluid">
              </div>
              ...
              <div class="card-footer">
                <form action="{{url('user_frontend_social_events_submit')}}" method="post">
                  @csrf
