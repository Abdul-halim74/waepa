  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Social Events List</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Admin</a></li>
              <li class="breadcrumb-item"><a href="#">Events</a></li>
              <li class="breadcrumb-item active">Social Events List</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Social Events List</h3>
              </div>
                ...
                <table id="example1" class="table table-bordered table-striped">
                 ...
                 @foreach($data as $single_data)
                  ...
                  <tr>
                    ...
                    <td> <img src="{{asset('uploads/social_events')}}/{{$single_data->image}}" alt="not found" height="100" width="100"></td>
                    ...
                    <td class="project-actions text-right">
                      ...
                      <a type="button" style="margin: 5px;" class="btn  btn-primary btn-sm  btnEditRowWithModal"> <i class="fas fa-search" style="color: #fff;">
                         ...
                         <!--  <a class="btn btn-primary btn-sm" href="#" data-toggle="modal" data-target=".bd-example-modal-lg" style="margin: 5px;">
                          ...
                          <a class="btn btn-info btn-sm" href="{{url('admin/social_events/edit')}}/{{$single_data->id}}" style="margin: 5px;">
...
<!-- end -:- Edit Modal -->
  ...
  <script type="text/javascript">
    ...
    $(".btnEditRowWithModal").click(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: "{{ url('admin/single_social_events_show') }}",
            data: formData,
    ...
    function deletebtn(id){
    	...
    	if(confirm("Want to delete?")) {
    		...
    		var formData = {
    		 ...
    		 $.ajax({
            type: 'POST',
            url: "{{ url('admin/single_social_events_delete') }}",
            data: formData,
            success: function(data) {
