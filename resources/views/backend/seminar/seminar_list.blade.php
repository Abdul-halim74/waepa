        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Seminar List</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Seminar List</h3>
              </div>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                      ...
                      @php $sn=1 @endphp  
                 @foreach($seminar as $single_data)
                  ...
                  <tr>
                    ...
                    <td> <img src="{{asset('uploads/seminar')}}/{{$single_data->image}}" alt="not found" height="100" width="100"></td>
                    ...
                    <td class="project-actions text-right">
                      ...
                      <a type="button" style="margin: 5px;" class="btn  btn-primary btn-sm  btnEditRowWithModal"> <i class="fas fa-search" style="color: #fff;">
                         ...
                         <!--  <a class="btn btn-primary btn-sm" href="#" data-toggle="modal" data-target=".bd-example-modal-lg" style="margin: 5px;">
                          ...
                          <a class="btn btn-info btn-sm" href="{{url('admin/seminar/edit')}}/{{$single_data->id}}" style="margin: 5px;">
...
<!-- end -:- Edit Modal -->
  ...
  <script type="text/javascript">
    ...
    $(".btnEditRowWithModal").click(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: "{{ url('admin/single_seminar_show') }}",
            data: formData,
    ...
    function deletebtn(id){
    	...
    	if(confirm("Want to delete?")) {
    		...
    		var formData = {
    		 ...
    		 $.ajax({
            type: 'POST',
            url: "{{ url('admin/single_seminar_delete') }}",
            data: formData,
            success: function(data) {
